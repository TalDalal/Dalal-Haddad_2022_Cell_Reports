function [allInt] = MTarchOBLightIntensityAnalysis(normFR)
%% OB recordings, while suppressing M/T cells
...
%% Experiment list
if ismac
    dataSet(1).exps = 1;dataSet(1).clu = 1;dataSet(1).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(2).exps = 3;dataSet(2).clu = 1;dataSet(2).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(3).exps = 4;dataSet(3).clu = [1,2];dataSet(3).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(4).exps = 6;dataSet(4).clu = [1,2];dataSet(4).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(5).exps = 9;dataSet(5).clu = [1,2,3];dataSet(5).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(6).exps = 16;dataSet(6).clu = 1;dataSet(6).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(7).exps = 17;dataSet(7).clu = [1,2];dataSet(7).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
    dataSet(8).exps = 20;dataSet(8).clu = 1;dataSet(8).dir = ...
        '/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/ArchT_MTcells25022020';
else
    dataSet(1).exps = 1;dataSet(1).clu = 1;dataSet(1).dir = ...
