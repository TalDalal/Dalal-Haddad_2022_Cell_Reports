function [allInt] = OBarchLightIntensityAnalysis()

if ismac
    cd('/Volumes/My Passport/Tal/Experiments/2019/InhibitionOfGC_GAD/M45GADCre_21072020')
else
    cd('E:\Tal\Experiments\2019\InhibitionOfGC_GAD\M45GADCre_21072020');
end
%% params
clear;clc
normFR = 1;
...
%% data
dataSet(1).exps = 1;dataSet(1).clu = 1;
dataSet(2).exps = 2;dataSet(2).clu = 1;
dataSet(3).exps = 3;dataSet(3).clu = 1;
dataSet(4).exps = 4;dataSet(4).clu = 1;
dataSet(5).exps = 5;dataSet(5).clu = 1;
dataSet(6).exps = 7;dataSet(6).clu = 1;
dataSet(7).exps = 9;dataSet(7).clu = 1;
%%
allInt = [];
